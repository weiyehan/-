...
allurls = [
    'https://www.celine.com/zht-hk/celine-%E7%94%B7%E8%A3%9D/%E6%89%8B%E8%A2%8B/']
...
for url0 in allurls:
    ...
    try:
        ...
        for i in range(41,len(price_xpaths)):
            detail = ""
            try:
                ...
                jasondata = {
                    ...
                    "Price": price,
                    "SaleVolume": "",
                    "SaleVolumeDes":description.splitlines()[0],
                    "Material": description.splitlines()[1],
                    "Detail": detail,
                    "sizeCodeList": ""
